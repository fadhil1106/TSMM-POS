            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/tambah_barang'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                            <label class="control-label col-xs-3" >Tenant</label>
                            <div class="col-xs-9">
                                <select name="kategori" class="selectpicker show-tick form-control" data-live-search="true" title="Pilih Tenant" data-width="80%" placeholder="Pilih Tenant" required>
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/edit_barang'?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                 <select name="satuan" class="selectpicker show-tick form-control" data-live-search="true" title="Pilih Satuan" data-width="80%" placeholder="Pilih Satuan" required>
                                    <option <?= ($satuan=='PCS') ? 'selected' : ''; ?>>PCS</option>
                                    <option <?= ($satuan=='Kotak') ? 'selected' : ''; ?>>Kotak</option>
                                    <option <?= ($satuan=='Botol') ? 'selected' : ''; ?>>Botol</option>
                                    <option <?= ($satuan=='Buah') ? 'selected' : ''; ?>>Buah</option>
                                    <option <?= ($satuan=='Butir') ? 'selected' : ''; ?>>Butir</option>
                                    <option <?= ($satuan=='Biji') ? 'selected' : ''; ?>>Biji</option>
                                    <option <?= ($satuan=='Sachet') ? 'selected' : ''; ?>>Sachet</option>
                                    <option <?= ($satuan=='Roll') ? 'selected' : ''; ?>>Roll</option>
                                    <option <?= ($satuan=='Centimeter') ? 'selected' : ''; ?>>Centimeter</option>
                                    <option <?= ($satuan=='Liter') ? 'selected' : ''; ?>>Liter</option>
                                    <option <?= ($satuan=='CC') ? 'selected' : ''; ?>>CC</option>
                                    <option <?= ($satuan=='Gram') ? 'selected' : ''; ?>>Gram</option>
                                    <option <?= ($satuan=='Kilogram') ? 'selected' : ''; ?>>Kilogram</option>
                                 </select>
                            </div>
                        </div>
