...
<head>
    <title>Laporan Penjualan Pertenant</title>
    <meta charset="utf-8">
...
<?php 
    $b=$jml->row_array();
    $tenant = array_unique(array_column($data->result_array(),'nama_tenant'));
?>
<table border="0" align="center" style="width:900px;margin-bottom:20px;">
<thead>
    <tr>
        <th style="text-align:right;">Tanggal : <?php echo $b['jual_tanggal'];?></th>
    </tr>

</thead></table>
<?php foreach ($tenant as $list) { ?>
<table border="1" align="center" style="width:900px;margin-bottom:20px;">
<thead>
    <tr>
        <th colspan="10" style="text-align: left;">Tenant : <?php echo $list ?></th>
    </tr>
    <tr>
...
<table align="center" style="width:900px; border:none;margin-top:5px;margin-bottom:20px;">
    <tr>
        <td style="text-align:right;width:760px;font-size:large"><b>Total</b></td>
        <td style="text-align:right;font-size:large"><b><?php echo ': Rp '.number_format($b['total']);?></b></td>
    </tr>
</table>
<table align="center" style="width:900px; border:none;margin-top:5px;margin-bottom:20px;">
    <tr>
